...
test_case.check_should_continue() once before and once after the step
runs - so a fatal Rulebook violation, an external stop request (see
...
.check_should_continue() - i.e. a TestCase.
"""
